...
from api.views import add_product, get_all_product, get_product, delete_product, update_product, get_products_by_model, get_products_by_price, get_products_in_range
